...
The event "researcher 45 gets a positive result" and "researcher 897 gets a positive result" are mutually exclusive. We would ask here:
...
An example of **non-disjoint** (within our 1000-researcher experiment) would be the event "researcher 45 gets a positive result" and "researcher 45 and reasearcher 67 gets a positive result".
...
2. &\ \mathbb{P}(\Omega) = 1 \text{: Probability, that any outcome occurs}\\
