...
$\mathbb{P}(A_1) = 0.04^2 + 0.04 \times 0.96$

$\mathbb{P}(A_2) = 0.04^2 + 0.96 \times 0.04$
...
the probability of both finding an effect, wich is the same as that both or exactly one of them finds an effect.
...
- Simulate the number of positive results in our 1000-researcher-experiment under the assumption that the therapy is not working at all ($p=0.04$).
- Do this experiment in R 10,000 times and visualize the results in a histogram.
