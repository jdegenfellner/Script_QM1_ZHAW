...
There are a myriad sources (books, webistes, videos) explaining the concepts of [descriptive statistics](https://en.wikipedia.org/wiki/Descriptive_statistics). 
...
- How widely are they spread?
  These questions are answered by the dispersion measures such as variance, standard deviation, or range.
- Are there any outliers (a rare data point that is far away from the rest [@westfall2020, p. 405].) and why?
...
- Was prior/external knowledge used in any of the analysis?
