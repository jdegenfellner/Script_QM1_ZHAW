...
talking about their experiments or their research methodology to each other. The statistician in the department has calculated (due to the variability of such treatment effects in the relevant population)
that even under the assumption of the therapy not working *at all*, one would see an effect just *by chance* in 4% of the study results.
