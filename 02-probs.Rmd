...
where \(\mathbb{P}\) is the probability measure which we will define more formally later.
...
**Example**: Throw your (unfair) die often enough and you will get a good estimate of the probability of getting a 3.
