...
if (knitr::is_html_output()) {
  ...
  grid.text("A_1", x = 0.25, y = 0.9, gp = gpar(fontsize = 16))
  grid.text("A_2", x = 0.75, y = 0.9, gp = gpar(fontsize = 16))
  grid.text("P(A_1 ∩ A_2) = 0", x = 0.5, y = 0.0, gp = gpar(fontsize = 16, col = "darkred"))
...
These two events are neither independent nor disjoint. The patient's motivation could influence the treatment effect, making the events dependent.
...
### Exercise4: {#exercise4} -  independent and disjoint
