...
For simplicity, let's just test two $\theta$-values: 0.3 (as in the previous study) and 0.4. We assign high confidence (say 85%) in the prior knowledge that the parameter 
$\theta=0.3$, since the previous study was well executed and had a large sample size.
