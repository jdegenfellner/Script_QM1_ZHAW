...
The probability of the event "" (nothing occurred) should be zero ($\mathbb{P}(\emptyset)=0$), were "" denotes the event that no researcher gets a positive or negative result ( = $\emptyset$, the so-called empty set). This is impossible due to the design of the experiment.
...
Obviously, the probability of an event should at a mininum be zero and at a maximum be one: $0 \le \mathbb{P}(A) \le 1$. 
...
### Exercise 11 - Independence and disjointness for dice events {#exercise11}
...
### Exercise 12 - Student's t-distribution {#exercise12}
...
- According to the text, [Figure 2](https://ars.els-cdn.com/content/image/1-s2.0-S0954611112002958-gr2_lrg.jpg) shows the means 
  $\pm$ standard errors (SE) of the ISWT at baseline, 8 weeks and 20 weeks for both groups. Look at Figure 2, a. 
...
- Now, let's simulate the differences at week 8 (ISWT) using the parameters given: Group sizes, 15 and 12, 
  ...
  Calculate the 1.5% and 98.5% quantiles.
