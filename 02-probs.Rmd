...
if (knitr::is_html_output()) {
  ...
  grid.text("A", x = 0.25, y = 0.9, gp = gpar(fontsize = 16))
  grid.text("B", x = 0.75, y = 0.9, gp = gpar(fontsize = 16))
  grid.text("P(A ∩ B) = 0", x = 0.5, y = 0.0, gp = gpar(fontsize = 16, col = "darkred"))
...
**Example** Events that are disjoint but not independent

**Example** Events that are independent but not disjoint
