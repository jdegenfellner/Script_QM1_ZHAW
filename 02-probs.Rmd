...
We can also visualize the 4 disjoint elementary events ($\Omega = \{ (R1pos, R2pos), (R1pos, R2neg), (R1neg, R2pos), (R1neg, R2neg) \}$) in a [Venn diagram](https://en.wikipedia.org/wiki/Venn_diagram). The probabilites of these
