...
Frequentist statistics is based on the idea that probability is the long-run frequency of events. For instance, if I throw a fair die 1000 times, the frequency of getting a 3 is (approximately) 1/6. In the limit, 
...
More genereally, in freuqentist statistics, we are looking for a fixed but unknown parameter from an underlying data generating process (DGP). 
...
Throw your (unfair) die often enough and you will get a good estimate of the probability of getting a 3.