...
If only researcher 45 finds an effect, then researcher 897 does not find an effect and vice versa. Hence, the two events are said to disjoint.
If we add up the probabilities of all mutually exclusive events, we should get 1, or 100%. We say that the probability of all elementary events (called $\omega$) sums to 1.
...
Two events $A$ and $B$ are independent if the occurrence of one event does not affect the occurrence of the other event. Although "aff"
