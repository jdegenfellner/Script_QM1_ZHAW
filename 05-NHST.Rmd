...
- **Sample size influence**: Large samples can make small, clinically irrelevant 
  ...
  always a sample size that makes the difference "significant". See [Exercise 2](#exercise2).
...
using exact tests if available, since we are in the 21th century and computers are fast.
