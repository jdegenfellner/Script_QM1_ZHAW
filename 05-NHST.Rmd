...
- if the true, but unobserved mean of a population is different from a specific value ([one sample $t$-test](https://en.wikipedia.org/wiki/Student%27s_t-test#One-sample_t-test)) or
...
### Two sample $t$-test
Let's jump right in and use our example from the previous chapter:
