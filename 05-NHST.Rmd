...
- conf.int is the confidence interval of the correlation coefficient at 95% (conf.int = $[-0.9360192, -0.7362129]$)
...
- Create a new sample by [drawing with replacement](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*iH5w0MBdiOlxDOCX6nmqqw.png) from the original sample.
...
The following intervals where obtained in the three different ways:
