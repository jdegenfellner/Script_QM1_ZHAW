...
constructed **repeatedly** everytime a new sample is drawn. 
...
This answer is typically given by the famous [t-test](https://en.wikipedia.org/wiki/Student%27s_t-test) (small "t" please).
...
**We want to know if the two groups differ in their means**.
...
difference of the means. We see a full probability distribution again.
...
We would then choose a value of 2 for the ROPE, since only are change beyound this value would be
...
This is also not the case here. We would not conclude that the means are 
