...
library(gifski)
library(magick)
img <- magick::image_read("./images/bayesian_updating_fixed.gif")
print(img)
```

This [video](https://www.youtube.com/watch?v=rUoJvogN7qQ&t=4s&ab_channel=CoreyChivers) illustrates the concept of Bayesian updating.
