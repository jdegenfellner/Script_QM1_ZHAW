...
More genereally, in Frequentist statistics, we are looking for \textbf{a fixed but unknown parameter from} an underlying data generating process (DGP).
...
\begin{verbatim}
## file:////private/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmphRJMGN/file1b0422796b61/widget1b045178bef5.html screenshot completed
\end{verbatim}
...
where \(X\) ist the \href{(https://www.youtube.com/watch?v=Y9nsL69CwbU&t=18s&ab_channel=VeryNormal)}{random variable} (which takes values \(x_i\) when the random experiment is conducted) and \(x_i\) are the possible outcomes of \(X\).
...
Note that the \textbf{sample varies everytime we draw from the population}.
...
\section{Univariate vs.~bivariate statisics}\label{univariate-vs.-bivariate-statisics}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-26-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-26-3.pdf}}
...
\begin{verbatim}
## file:////private/var/folders/pm/jd6n6gj10371_bml1gh8sc5w0000gn/T/RtmphRJMGN/file1b041dad7a6c/widget1b04684057ac.html screenshot completed
\end{verbatim}

\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-31-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-34-1.pdf}}

\begin{verbatim}
## [1] 164  97
\end{verbatim}

\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-34-2.pdf}}

\begin{verbatim}
## [1] 164  72
\end{verbatim}

\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-34-3.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-35-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/bar_plot_code-1.pdf}}

\textbf{After} collecting data, we have updated our prior beliefs about the defect rate:

R codes are in the \href{https://github.com/jdegenfellner/Script_QM1_ZHAW/blob/main/04-Bayes_statistics.Rmd}{git} repository

\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-36-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-37-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-38-1.pdf}}
...
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-39-1.pdf}}
\item
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-40-1.pdf}}
...
\href{https://en.wikipedia.org/wiki/Confidence_interval\#/media/File:Normal_distribution_50\%25_CI_illustration.svg}{constructed \textbf{repeatedly} everytime a new sample is drawn}.
...
## mu1       130.827 130.832 132.243   93   32.2609 228.12                  
## mu2         6.165   5.864   5.243   93  -86.0171  92.96                  
## muDiff    124.663 125.150 131.106   93   -8.3047 257.01       0      95.7
## sigma1    140.003 128.413 112.514   93   66.6072 226.01                  
## sigma2    129.675 119.502 105.120   93   62.7136 210.02                  
## sigmaDiff  10.328   8.569   5.721   93 -115.1168 138.06       0      56.4
## nu         34.508  25.895  10.194   93    1.0722  83.83                  
## log10nu     1.381   1.413   1.485   93    0.6665   2.06                  
## effSz       0.967   0.957   0.953   93   -0.0735   2.02       0      95.7
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/testing-1.gif}}
\caption{\label{fig:testing}example caption}
\end{figure}
...
Let's revisit \hyperref[example_defective_products]{Example 1} and change the prior probabilites to
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-45-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-46-1.pdf}}
...
## mu1        0.713  0.709  0.723   93 -0.544  1.989                          
## mu2        2.301  2.299  2.294   93  0.922  3.747                          
## muDiff    -1.589 -1.590 -1.565   93 -3.475  0.315       0      6.17    -1.8
## sigma1     2.041  1.926  1.707   93  1.080  3.092                          
## sigma2     2.308  2.172  1.967   93  1.267  3.506                          
## sigmaDiff -0.267 -0.242 -0.161   93 -1.993  1.390       0     37.24        
## nu        36.109 27.598 11.783   93  1.472 85.986                          
## log10nu    1.412  1.441  1.489   93  0.720  2.057                          
## effSz     -0.750 -0.747 -0.785   93 -1.641  0.131       0      6.17        
##           ROPEhigh %InROPE
## mu1                       
## mu2                       
## muDiff         1.8    58.2
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-46-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/bar_plot_code_ueb-1.pdf}}
...
\item
  ...
  The alternative ist that one treatment is \href{https://en.wikipedia.org/wiki/Clinical_study_design\#Other_terms}{superior to the other}.
\item
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-61-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-70-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-71-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-71-2.pdf}}
...
\subsection{Exercise 6 - correlation coefficent}\label{exercise6_nhst}
