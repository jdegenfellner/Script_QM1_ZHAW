...
This \href{https://www.youtube.com/watch?v=gSEYtAjuZ-Y&ab_channel=KhanAcademy}{video} might be helpful to cover the basics of a histrogram.
I recommend plotting the histogram with a \href{https://en.wikipedia.org/wiki/Box_plot}{boxplot} below:
...
\CommentTok{\# only available in RStudio}
...
We will try to catch a histrogram in the \emph{wild} (=research paper): We find one
