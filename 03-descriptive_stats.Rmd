...
measure of other kinds of relationships (for instance monotonic or polynomial). The correlation coefficient can take values between -1 and 1.
...
One thing many of us thing when they see a high correlation (near 1) is that if we know the value of one variable,
