...
- Draw a sample of 165 persons from this distribution and calculate the mean and standard deviation of the sample. 
  How good is the estimate of the true (and in this case: known) meand and standard deviation?
- Let's replace some of the data points with outliers. Change the score of 5 persons with to inmpossible CognFlex score of 100. 
...
### Exercise XXXX - Recreating data in Table 2 {#exercise1_descriptive_stats}
