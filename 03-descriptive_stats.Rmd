...
between -12 and 12. But that should not be a problem with so many levels of an ordered categorical variable. 
...
See [Exercise 4](#exercise4_descriptive_stats).
...
- Try different paramter values for $\mu$ and $\sigma$ and plot the histogram of the z-scores.
