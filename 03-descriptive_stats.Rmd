...
We will try to catch a histrogram in the *wild* (=research paper): We find one 
...
the foot posture index (FPI-6) scores from the participants (3217 healthy children).
