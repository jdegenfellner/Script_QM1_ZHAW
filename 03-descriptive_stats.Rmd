...
In **Table 2** of the paper, the authors present the baseline characteristics of the patients stratified by the treatment group (usual care vs CFT).
...
Note that the **sample varies every time we draw from the population**. 
