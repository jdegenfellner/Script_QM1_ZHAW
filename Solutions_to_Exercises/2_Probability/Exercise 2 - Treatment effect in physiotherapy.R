...
p_theta1_data # 0.1178669 # Probability that theta = 0.3 after seeing the new data
p_theta2_data # 0.8821331 # Probability that theta = 0.4 after seeing the new data
