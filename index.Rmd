...
We are following a **two-tier** approach to R. The **first tier** jumps right into solving 
exercises and problems with R using GPT. This anticipates the capacities of the software 
without knowing the details yet. The **second tier** is a more detailed approach to R, 
