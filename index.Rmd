...
realm of **inferential statistics**. Simply put, we want to find out if the, for example, the treatment effect
we are seeing in the sample is also present in the population or if what we are seeing was just by chance. 
We also add measures of uncertainty (for instance confidence intervals) to our estimates.
